...
// Image transitions are centralized in VulkanContext (sync2-first).
                            ...
                            const uint8_t* rgbaPixels)
{
    ...
    vk.transitionImageAuto(up.cmd(), tex.image, VK_IMAGE_ASPECT_COLOR_BIT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL);
    ...
    vk.transitionImageAuto(up.cmd(), tex.image, VK_IMAGE_ASPECT_COLOR_BIT, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
